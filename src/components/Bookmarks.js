...
function Bookmarks(args) {
  ...
  const gaEventTracker = useAnalyticsEventTracker('Bookmarks');
  return (
                        ...
                        {data?.submitresrcId?.link ? (
                          <>
                            <iframe
                              ...
                              src={`https://www.youtube.com/embed/${data?.submitresrcId?.link?.split("=")[1]
                                }`}
                            ></iframe>
                          </>
                        ) : null}
                        ...
                        <Row key={data?.submitresrcId?._id}>
                          ...
                          <Col lg="8" key={data?.submitresrcId?._id}>
                            <button
                              ...
                              color="success"
                              onClick={() =>
                                (removebookmark(data?.submitresrcId?._id), gaEventTracker('Remove bookmark'))
                              }
                            >
                              Remove bookmark
                            </button>
