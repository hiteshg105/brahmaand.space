...
function ProductHastag(args) {
  ...
  const handlefilter = filtertype => {
    ...
    axios
      ...
      .then(res => {
        console.log(res.data.data[0].sub_category.desc)
        setSearchBarName(res.data.data[0].sub_category.desc)
                          ...
                          <Container>
                            ...
                            >
                              ...
                              {relyear
                                ...
                                .sort((a, b) => b.yrName.localeCompare(a.yrName)) // Sort the array in ascending order based on yrName
                                .map((yr) => (
                                  <option value={yr?._id} key={yr?._id}>
                                    {yr?.yrName}
                                  </option>
